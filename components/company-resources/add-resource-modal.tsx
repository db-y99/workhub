...
import { createCompanyResource } from "@/lib/actions/company-resources";
        ...
        {() => (
          <>
            <ModalHeader className="flex flex-col gap-1">
              <h2 className="text-2xl font-bold">Thêm tài nguyên công ty</h2>
              <p className="text-sm text-default-500 font-normal">
                Ghi nhận tài khoản, máy tính hoặc tài sản khác để theo dõi bàn giao
              </p>
            </ModalHeader>
            <ModalBody>
              {error && (
              ...
              <div className="flex flex-col gap-4">
                <Input
                  ...
                  placeholder="VD: Laptop Dell XPS, Tài khoản Google Workspace"
                  value={formData.name}
                  onValueChange={(value) =>
