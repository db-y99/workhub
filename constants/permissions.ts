...
export const PERMISSION_PAGES = [
  ...
  { code: "loans", name: "Send email", description: "Gửi email khoản vay", sort_order: 3 },
  { code: "company-resources", name: "Tài nguyên công ty", description: "Quản lý tài nguyên công ty", sort_order: 4 },
  { code: "statistics", name: "Thống kê", description: "Xem thống kê", sort_order: 5 },
  { code: "users", name: "Người dùng", description: "Quản lý người dùng", sort_order: 6 },
  { code: "departments", name: "Phòng ban", description: "Quản lý phòng ban", sort_order: 7 },
  { code: "roles", name: "Vai trò", description: "Quản lý vai trò", sort_order: 8 },
  { code: "permissions", name: "Phân quyền", description: "Quản lý phân quyền theo vai trò", sort_order: 9 },
